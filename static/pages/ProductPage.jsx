...
const ProductPage = class extends React.Component {
    ...
    componentDidMount () {
        ...
        const slugPart = this.props.match.params.product.toString();
        const slugParts = slugPart.split("-");
        const key = slugParts[0];
        fetch(`/api/products?key=${key}`)
    ...
    renderProducts() {
        ...
        let items = <div>
            ...
            <img src={"../" + this.state.product[0].img} width="100%"></img>
            </div>
            <div className="col-md-8 product">
                <table className="table table-sm">
                    <tbody>
                        <tr>
                            <td>Цена</td>
                            <td>{this.state.product[0].price} руб.</td>
                        </tr>
                        <tr>
                            <td>Масса</td>
                            <td>2.5 кг.</td>
...
return <ProductBox title={this.state.product[0].title}>{ items }</ProductBox>;
